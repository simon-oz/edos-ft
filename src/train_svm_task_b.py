#!/usr/bin/env python3
# src/train_svm_task_b.py
"""
Train a TF-IDF + LinearSVC classifier for EDOS Task B (4-category classification).

Changes from Task A:
- Updated default paths to task_b_{train,dev,test}.csv.
- Dynamically reads target_names from the 'label_category' column.
- Updated logging to handle multi-class prediction distributions.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train TF-IDF + LinearSVC for EDOS Task B")
    ...
    parser.add_argument("--out_dir", default="models/svm_task_b")
    ...
    log_file = LOG_DIR / f"svm_task_b_train_{timestamp}.log"
    ...
    model_path = out_dir / "svm_task_b_pipeline.joblib"
